...
const Home: React.FC = (): React.ReactElement => {
  ...
  const customSlider = React.useCallback(() => {
      ...
      document.querySelector('#labelWeeding')!.addEventListener("click", () =>{
        ...
        step = document.querySelector("#portfolio__weeding > .port__slider > #ul > li")
        quantity = document.querySelectorAll("#portfolio__weeding > .port__slider > #ul > li").length
        slideWidth = 0
        currentSlide = 1
...
///////////////////////////////////////////////////////////
      document.querySelector('#labelNight')?.addEventListener('click', ()=>{
      ...
      step = document.querySelector("#portfolio__night > .port__slider > #ul > li")
      quantity = document.querySelectorAll("#portfolio__night > .port__slider > #ul > li").length
      slideWidth = 0
      currentSlide = 1
...
///////////////////////////////////////////////////////////
      document.querySelector('#labelDay')?.addEventListener('click', () => {
        document.getElementById('portfolio__weeding')!.style.display = "none"
      document.getElementById('portfolio__night')!.style.display = "none"
      document.getElementById('portfolio__day')!.style.display = "block"

      step = document.querySelector("#portfolio__day > .port__slider > #ul > li")
      quantity = document.querySelectorAll("#portfolio__day > .port__slider > #ul > li").length
      slideWidth = 0
      currentSlide = 1
  ...
  <section className="services">
    ...
    <div className="services__wrap">
      ...
      <div id="srvice__lastSlide_opacity" className="srvice__lastSlide_opacity"></div>
    </div>
    ...
    <div className="portolio__wrap">
      ...
      <div className="portfolio__section">
        <div className="portfolio__toogle">
          ...
          <label id='labelWeeding' htmlFor="weeding">Свадебный макияж</label>
          <input id="night" name="portfolio" type="radio" />
          <label id='labelNight'  htmlFor="night">Вечерний макияж</label>
          <input id="day" name="portfolio" type="radio" />
          <label id='labelDay' htmlFor="day">Дневной макияж</label>
        </div>
    ...
    <div className="courses__wrap">
      ...
      <div className="courses__content">
        <div className="courses__box">
          ...
          <label htmlFor="Записаться на курс" className="courses_btn">Записаться на курс</label>
        </div>
        <div className="courses__box">
      ...
      <div className="about__contentWrap">
        <div className="about__box">
          ...
          <div className="about__box__text">
            <ul>
              <li>Привет! Я Мария Семенова, международный визажист с 12 летним стажем.</li>
              <li>Я люблю свою деятельность, и отношусь к ней не как к работе, а как к творчеству.</li>
              <li>Обращаясь ко мне, Вы получаете широкий спектр качественных услуг по приемлемым ценам.</li>
            </ul>
          </div>
        ...
        <div className="about__sn">
          <a href="/"><img src="/img/Instagram_color.svg" alt="" /></a>
          <a href="/"><img src="/img/Facebook_color.svg" alt="" /></a>
        </div>
      </div>
    </div>
  ...
  <section className="services reviews">
    ...
    <div className="reviews__wrap">
      ...
      <div ref={reviewsText} className="services__wrap reviews__wrap__textReviews">
        <hr />
          <div className="slider multiple-items">
            <SlickSlider {...settingsOne}>
            <div>
  ...
  <section className="services instagram">
    ...
    <div className="services__wrap">
        <div className="instagram__title">
          ...
          <a href="https://www.instagram.com/mariyasafirmua/" target="blank"><span>@mariyasafirmua</span></a>
  ...
  <footer>
    <div className="footer__wrap">
      <div className="footer__logo">
        <a href="/"><img src="/img/logo_white.svg" alt="" /></a>
      </div>
      ...
      <div className="footer__bottom">
        <div className="footer__copywriting">
          <p>© 2020 <a href="https://itd.company/">ITD Company.</a>  All rights reserved</p>
        </div>
